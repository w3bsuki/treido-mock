...
export const Header: React.FC = () => {
  return (
    <div className="pt-safe-top">
      ...
      {/* Search Input - Tighter (h-9), Zinc-100 bg, rounded-md */}
      <div className="px-3 pb-1">
        <div className="relative group">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            <Search className="h-[14px] w-[14px] text-zinc-400 group-focus-within:text-zinc-600 transition-colors" />
          </div>
          <input
            type="text"
            className="block w-full h-9 pl-9 pr-4 bg-zinc-100 border border-transparent focus:border-zinc-300 rounded-md text-zinc-900 text-[14px] font-medium placeholder-zinc-400 focus:outline-none focus:bg-white transition-all"
            placeholder="Търсене..."
          />
        </div>
      </div>
